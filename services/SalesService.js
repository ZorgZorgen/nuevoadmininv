...
const create = async (sales) => {
  /* 
    Valida si los productos en el array de 'sales existen' y si la cantidad de productos en el array de 'sales' es menor o igual a la cantidad de productos en el inventario
